...
video_file_path = 'demo.mp4'  # Replace with the path to your video file
...
classNames = []
classFile = 'names'  # Path to your names file
with open(classFile, 'rt') as f:
    classNames = f.read().rstrip('\n').split('\n')

# Load the pre-trained model (SSD = Single Shot Multibox Detector)
configPath = 'ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt'
weightsPath = 'frozen_inference_graph.pb'  # Path to your model files
